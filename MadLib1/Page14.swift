    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            ...
            HStack(alignment: .center) {
                Spacer()
                Text("Now choose an PLURAL sea creatures. 🐬 🐳 🍤")
                    .font(.largeTitle)
                    .padding()
            ...
            HStack {
                Spacer()
                NavigationLink(destination: Page15(word: word), isActive: $isValid) {
                    EmptyView()
                 }
...
struct Page14_Previews: PreviewProvider {
