...
struct Page12: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            ...
            HStack {
                Spacer()
                NavigationLink(destination: Page13(word: word), isActive: $isValid) {
                    EmptyView()
                 }
...
struct Page12_Previews: PreviewProvider {
